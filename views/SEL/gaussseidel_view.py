...
def mostrargaussSeidel():
    ...
    if st.button("Calcular Método de Gauss Seidel"):
        ...
        ok, msg, iteraciones = ejecutarGaussSeidel(matriz_ord, vector_b_ord, tol)
                ...
                for i in range(n):
                    ...
                    for j in range(n):
                        ...
                        if i != j:
                            ...
                            # ==================================
                            # EN GAUSS-SEIDEL:
                            # j < i usa nuevos valores
                            # j > i usa valores anteriores
                            # ==================================
